...
export default function SessionDetail() {
  ...
  // ==== LAPORAN PEMBAGIAN HASIL (berdasarkan pembayaran yang sudah masuk) ====
  ...
  return (
    <>
      ...
      <div style={{ border: '2px solid #14110D', background: '#fff', marginBottom: '24px' }}>
        <div style={{ padding: '14px 20px', borderBottom: '2px solid #14110D', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ border: '2px solid #14110D', background: '#fff', marginTop: '24px' }}>
        ...
        <div style={{ padding: '20px' }}>
          ...
          <div style={{ border: '1px solid #c9c1ad', marginBottom: '22px' }}>
          ...
          {/* SELISIH */}
          <div style={{ marginTop: '18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '14px', padding: '16px 18px', background: selisihPositive ? '#14110D' : '#9a3a2a', color: selisihPositive ? '#F2EEE4' : '#fff' }}>
            <div>
          ...
          {cur === 'done' && !sess.splitConfirmed && (
            <div style={{ marginTop: '18px', border: '2px dashed #14110D', background: '#F2EEE4', padding: '18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '14px', flexWrap: 'wrap' }}>
          ...
          {sess.splitConfirmed && (
            <div style={{ marginTop: '18px', border: '2px solid #1f7a3d', background: '#eef6ef', padding: '16px 18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '14px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
